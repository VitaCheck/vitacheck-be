...
public class QUserTermsAgreement extends EntityPathBase<UserTermsAgreement> {
    ...
    private static final long serialVersionUID = 2087918821L;
    ...
    public final com.vitacheck.domain.QTerms terms;
    ...
    public QUserTermsAgreement(Class<? extends UserTermsAgreement> type, PathMetadata metadata, PathInits inits) {
        ...
        this.terms = inits.isInitialized("terms") ? new com.vitacheck.domain.QTerms(forProperty("terms")) : null;
