...
public class QBrand extends EntityPathBase<Brand> {
    ...
    private static final long serialVersionUID = -297338800L;
    ...
    public final ListPath<Supplement, QSupplement> supplements = this.<Supplement, QSupplement>createList("supplements", Supplement.class, QSupplement.class, PathInits.DIRECT2);
