...
public class TestController {
    ...
    public CustomResponse<List<FoodSafetyApiResponseDto.SupplementInfo>> searchByRecognitionNo(
    ...
    public CustomResponse<List<FoodSafetyApiResponseDto.SupplementInfo>> searchByRawMaterial(
